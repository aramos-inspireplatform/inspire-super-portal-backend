...
import { corsFactory } from '~/shared/infra/nestjs/factories/cors.factory';
...
import { useGlobalFilters } from '~/shared/infra/nestjs/factories/use-global-filters.factory';
