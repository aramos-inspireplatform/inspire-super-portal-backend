...
import { States } from '~/database/entities/states';
import { TimeZones } from '~/database/entities/time-zones';
...
import { UserLogins } from '~/database/entities/user-logins';
import { UserRoles } from '~/database/entities/user-roles';
